...
public class CashVoucherPrintActivity extends AppCompatActivity {
    Button payPrint;
    String paymentmodestr,custname,date,srno,description,count,amountstr,remarkStr,transactionStr,series,vch_no;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transactionStr = i.getStringExtra("transaction_id");
        remarkStr=i.getStringExtra("remarks");
        series = i.getStringExtra("series");
...
//"[R]"+SharedPref.getInstance(this).getTermsText()+"\n"
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(CashVoucherPrintActivity.this, Transactions.class));
    }
}