...
public class durasearchadapter extends ArrayAdapter<ItemCode> {
...
public durasearchadapter(Context context,List<ItemCode> itemCo)
        {
...
private class searchfilter extends Filter
{
    ...
    private durasearchadapter searchAdapter;
    public List<ItemCode> itemCodeList;
    Context context;

    public  searchfilter(durasearchadapter searchAdapter,Context context){
        super();
    ...
    protected FilterResults performFiltering(CharSequence constraint) {
        ...
        {
            DurasyncHelper syncHelper=new DurasyncHelper(context);
