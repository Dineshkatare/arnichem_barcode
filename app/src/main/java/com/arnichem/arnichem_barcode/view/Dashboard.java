...
public class Dashboard extends AppCompatActivity implements Listener, LocationData.AddressCallBack{
    ...
    CardView vehicle,Barcode,transactions,Producation,GooglePay,Godown,logout,file_upload,setting,PrintReceipt,Payment_Receipt,CRM,DieselEntry,customerHoldCl,logCL,otherCl;
