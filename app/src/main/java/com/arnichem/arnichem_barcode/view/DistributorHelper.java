...
public class DistributorHelper extends SQLiteOpenHelper {
    ...
    public DistributorHelper(Context context) {
     ...
     * */
    public void
    addcust(String title, String author){
    ...
    public String getcheck(String name)
    {
        String res = "";
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor c=db.rawQuery("SELECT * FROM "+TABLE_NAME+" WHERE "+COLUMN_CODE+" = '"+name+"'", null);
