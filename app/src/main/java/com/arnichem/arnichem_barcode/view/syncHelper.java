...
public class syncHelper extends SQLiteOpenHelper {
    ...
    public void addBook(String cyl_no, String barcode, String weight, String volume, String fillwith, String serial_no,
            String hydrotest_date, String owner, String status, String water_capacity, String mfg, String location) {
    ...
    public List<ItemCode> searchAllData(String searchStr) {
        ...
        try {
            ...
            Cursor cursor = sqLiteDatabase.rawQuery(
                    "SELECT * FROM " + TABLE_NAME + " where " + COLUMN_item_code + " LIKE ?",
            ...
            if (cursor.moveToNext()) {
                ...
                do {
                    ...
                    itemCode.setFilled_with(cursor.getString(5));
