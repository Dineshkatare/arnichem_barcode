...
public class VehicleHandler extends SQLiteOpenHelper {
    ...
    public void insertLabel(String label){
        ...
        // Inserting Row
        db.insertWithOnConflict(TABLE_NAME, null, values,SQLiteDatabase.CONFLICT_REPLACE);//tableName, nullColumnHack, CotentValues// Closing database connection
    }
