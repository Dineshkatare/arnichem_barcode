...
public class OrderMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Order Entry");
...
// Set the default date to current date on the TextView
        ...
        fromDate.setOnClickListener(v -> {
            DatePickerDialog datePickerDialog = new DatePickerDialog(OrderMainActivity.this,
    ...
    private void submitOrder() {
        ...
        progressDialog = new ProgressDialog(OrderMainActivity.this);
        ...
        Call<LeaveResponse> call = apiInterface.submitOrder(dbHost, dbUsername, dbPassword, dbName, cust_code, orderMsg, user, remarks, formattedDate);
        ...
        call.enqueue(new Callback<LeaveResponse>() {
            ...
            public void onResponse(Call<LeaveResponse> call, Response<LeaveResponse> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    intent.putExtra("link", "https://arnisol.com/intranet/view_business_partner.php?code="+cust_code);
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(intent);
                    Toast.makeText(OrderMainActivity.this, response.body().getMessage(), Toast.LENGTH_SHORT).show();
                    finish();
                } else {
                    Toast.makeText(OrderMainActivity.this, "Order submission failed", Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<LeaveResponse> call, Throwable t) {
                progressDialog.dismiss();
                Toast.makeText(OrderMainActivity.this, "Error: " + t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
