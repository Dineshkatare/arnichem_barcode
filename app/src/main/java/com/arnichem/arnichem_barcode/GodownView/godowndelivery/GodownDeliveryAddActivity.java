...
public class GodownDeliveryAddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myDB=new GodownDeliveryHelper(GodownDeliveryAddActivity.this);
        synchelper=new syncHelper(GodownDeliveryAddActivity.this);
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(res==null)
                        {
                            Toast.makeText(GodownDeliveryAddActivity.this, "null", Toast.LENGTH_SHORT).show();
...
//        });
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GodownDeliveryAddActivity.this, InWardMain.class));
            }
        });
