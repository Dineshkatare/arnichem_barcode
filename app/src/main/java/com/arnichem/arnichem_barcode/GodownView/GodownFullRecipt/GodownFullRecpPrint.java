...
import com.arnichem.arnichem_barcode.PrintReceipt.GodownFullReceiptmain.GodownFullPrintDB;
...
public class GodownFullRecpPrint extends AppCompatActivity {
    ...
    GodownFullReciptHelper addClymyDB;
    ArrayList<String> newlist;
    GodownFullPrintDB godownFullPrintDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addClymyDB=new GodownFullReciptHelper(GodownFullRecpPrint.this);
        ...
        godownFullPrintDB=new GodownFullPrintDB(this);
...
//        cylindernumberempty.setText(joined);
        ...
        Filled_with_Recycle_View=findViewById(R.id.fillwithrec);
        filledWithAdapter = new FilledWithAdapter(GodownFullRecpPrint.this, this, name, tot);
        Filled_with_Recycle_View.setAdapter(filledWithAdapter);
        cylinderNamePrintAdapter = new CylinderNamePrintAdapter(GodownFullRecpPrint.this, this, cylIdList, newlist, fillWithList);
        cyclinderNames.setAdapter(cylinderNamePrintAdapter);
        cyclinderNames.setLayoutManager(new LinearLayoutManager(GodownFullRecpPrint.this));
        Filled_with_Recycle_View.setLayoutManager(new LinearLayoutManager(GodownFullRecpPrint.this));
    ...
    public void cylinder() {
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                godownFullPrintDB.addBook(cursor.getString(1),DateFormat.getDateTimeInstance().format(new Date()),custcode,custname,count,empb);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(GodownFullRecpPrint.this, GOdownMainActivity.class));
    }
    void check(){
