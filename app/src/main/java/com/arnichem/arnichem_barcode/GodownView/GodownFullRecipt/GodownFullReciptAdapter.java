...
public class GodownFullReciptAdapter extends RecyclerView.Adapter<GodownFullReciptAdapter.GodownFullReciHolder> {
    private Context context;
    private Activity activity;
    private ArrayList book_id, book_title, filled_with;

    GodownFullReciptAdapter(Activity activity, Context context, ArrayList book_id, ArrayList book_title,
    ...
    @NonNull
    @Override
    public GodownFullReciHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.my_row_outward, parent, false);
        return new GodownFullReciHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull @NotNull GodownFullReciHolder holder, int position) {
    ...
    class GodownFullReciHolder extends RecyclerView.ViewHolder {

        TextView book_title_txt, fillwithTxt;
        ConstraintLayout mainLayout;
        ImageView deleteBtn;

        GodownFullReciHolder(@NonNull View itemView) {
            super(itemView);
