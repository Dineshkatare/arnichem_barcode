...
public class GodownEmptyMainActivity extends AppCompatActivity implements Listener, LocationData.AddressCallBack {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        synchelper = new syncHelper(GodownEmptyMainActivity.this);
        ...
        check();
        filledWithAdapter = new FilledWithAdapter(GodownEmptyMainActivity.this, this, name, tot);
        fillwithrec.setAdapter(filledWithAdapter);
        fillwithrec.setLayoutManager(new LinearLayoutManager(GodownEmptyMainActivity.this));
    ...
    private void loadata() {
        ...
        godownemptycylindernumber.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String selectedCyl = godownemptycylindernumber.getText().toString();
                String filledWith = "";
                String volume = "";
                ...
                myDB.addBook(selectedCyl, filledWith, volume, "N");
                finish();
                startActivity(getIntent());
            }
        });
    ...
    private void postUsingVolley() {
        ...
        if (poslocfixdel == 0) {
            dialog.dismiss();
            button.setEnabled(true);
            MDToast.makeText(GodownEmptyMainActivity.this, "कृपया लोकेशन निवडा !", MDToast.LENGTH_SHORT,
                    MDToast.TYPE_ERROR).show();

        } else if (poscustfixdel == 0) {
            dialog.dismiss();
            button.setEnabled(true);
            MDToast.makeText(GodownEmptyMainActivity.this, "कृपया ग्राहक निवडा !", MDToast.LENGTH_SHORT,
                    MDToast.TYPE_ERROR).show();
                            ...
                            try {
                                ...
                                for (int i = 0; i < array.length(); i++) {
                                    ...
                                    if (status.equals("success")) {
                                        MDToast.makeText(GodownEmptyMainActivity.this, "Empty Entry Done!",
                                                MDToast.LENGTH_SHORT, MDToast.TYPE_SUCCESS).show();
                                        MDToast.makeText(GodownEmptyMainActivity.this, "आता प्रिंट बटण दाबा !",
                                                MDToast.LENGTH_SHORT, MDToast.TYPE_SUCCESS).show();
                                        ...
                                        dialog.dismiss();
                                        Intent intent = new Intent(GodownEmptyMainActivity.this,
                                                GOdownEmptyprint.class);
                                        intent.putExtra("durano", String.valueOf(cylinder));
                                        intent.putExtra("custname", to_warehouse);
                                        intent.putExtra("empb", srno);
                                        intent.putExtra("count", count);
