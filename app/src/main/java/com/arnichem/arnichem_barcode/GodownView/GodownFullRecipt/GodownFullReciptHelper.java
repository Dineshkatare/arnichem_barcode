...
public class GodownFullReciptHelper extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "GodownFullRecipt.db";
    ...
    public GodownFullReciptHelper(@Nullable Context context) {
