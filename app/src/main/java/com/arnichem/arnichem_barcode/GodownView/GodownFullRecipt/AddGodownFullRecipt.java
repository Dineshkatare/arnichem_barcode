...
public class AddGodownFullRecipt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_godown_full_recipt);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        frameLayout=findViewById(R.id.frameinward);
        myDB=new GodownFullReciptHelper(AddGodownFullRecipt.this);
        synchelper=new syncHelper(AddGodownFullRecipt.this);
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(res==null)
                        {
                            Toast.makeText(AddGodownFullRecipt.this, "null", Toast.LENGTH_SHORT).show();
...
//        });
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(AddGodownFullRecipt.this, InWardMain.class));
            }
        });
