...
public class closing_helper extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "closing_helper.db";
    ...
    public closing_helper(@Nullable Context context) {
