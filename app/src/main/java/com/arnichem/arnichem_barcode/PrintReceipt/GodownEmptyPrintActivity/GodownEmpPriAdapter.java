...
import com.arnichem.arnichem_barcode.PrintReceipt.GodownDeliveryPrintActivity.GodownDeliveryPrintAdapter;
...
public class GodownEmpPriAdapter extends RecyclerView.Adapter<GodownEmpPriAdapter.OxygenHolder>{
    private Context context;
    private Activity activity;
    private ArrayList id;
    private ArrayList dcno;
    GodownEmpPriAdapter(Activity activity, Context context, ArrayList id, ArrayList dcno
    ){
    ...
    public void onBindViewHolder(@NonNull @NotNull OxygenHolder holder, int position) {
        ...
        holder.dcno.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, GodownEmptyPrintView.class);
