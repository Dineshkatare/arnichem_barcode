...
public class DuraEmptyPrintDB  extends SQLiteOpenHelper {
    private Context context;
    private static final String DATABASE_NAME = "DuraEmptyPrintDB.db";
    ...
    public DuraEmptyPrintDB(@Nullable Context context) {
