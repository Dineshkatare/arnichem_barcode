...
public class FullRecePrintAdapter extends RecyclerView.Adapter<FullRecePrintAdapter.OxygenHolder>{
    private Context context;
    private Activity activity;
    private ArrayList id;
    private ArrayList dcno;
    FullRecePrintAdapter(Activity activity, Context context, ArrayList id, ArrayList dcno
    ){
