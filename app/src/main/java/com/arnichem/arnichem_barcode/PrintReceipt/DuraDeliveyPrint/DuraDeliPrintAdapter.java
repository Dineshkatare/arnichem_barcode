...
public class DuraDeliPrintAdapter extends RecyclerView.Adapter<DuraDeliPrintAdapter.OxygenHolder>{
    private Context context;
    private Activity activity;
    private ArrayList id;
    private ArrayList dcno;
    DuraDeliPrintAdapter(Activity activity, Context context, ArrayList id, ArrayList dcno
    ){
    ...
    @NonNull
    @Override
    public DuraDeliPrintAdapter.OxygenHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.cardprintrec, parent, false);
        return new DuraDeliPrintAdapter.OxygenHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull @NotNull DuraDeliPrintAdapter.OxygenHolder holder, int position) {
