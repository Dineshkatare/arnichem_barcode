...
import com.arnichem.arnichem_barcode.PrintReceipt.GodownEmptyPrintActivity.GodownEmptyPrintView;
...
public class GodownDeliveryPrintAdapter extends RecyclerView.Adapter<GodownDeliveryPrintAdapter.OxygenHolder>{
    private Context context;
    private Activity activity;
    private ArrayList id;
    private ArrayList dcno;
    GodownDeliveryPrintAdapter(Activity activity, Context context, ArrayList id, ArrayList dcno
    ){
