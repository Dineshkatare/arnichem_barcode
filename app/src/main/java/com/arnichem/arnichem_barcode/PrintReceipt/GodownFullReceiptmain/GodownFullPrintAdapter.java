...
import com.arnichem.arnichem_barcode.PrintReceipt.GodownEmptyPrintActivity.GodownEmpPriAdapter;
...
public class GodownFullPrintAdapter extends RecyclerView.Adapter<GodownFullPrintAdapter.OxygenHolder>{
    private Context context;
    private Activity activity;
    private ArrayList id;
    private ArrayList dcno;
    GodownFullPrintAdapter(Activity activity, Context context, ArrayList id, ArrayList dcno
    ){
    ...
    public void onBindViewHolder(@NonNull @NotNull OxygenHolder holder, int position) {
        ...
        holder.dcno.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(context, GodownFullRecPrintVIew.class);
