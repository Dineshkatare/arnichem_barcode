...
import com.arnichem.arnichem_barcode.PrintReceipt.DuraDeliveyPrint.DuraDeliPrintView;
...
public class DuraEmptyPrintView extends AppCompatActivity {
    ...
    DuraEmptyPrintDB addClymyDB;
    ArrayList<String> newlist;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_duraemptyprint);
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        empbid=findViewById(R.id.empbid);
        dateid=findViewById(R.id.dateid);
        addClymyDB=new DuraEmptyPrintDB(DuraEmptyPrintView.this);
    ...
    public AsyncEscPosPrinter getAsyncEscPosPrinter(DeviceConnection printerConnection) {
        ...
        return printer.setTextToPrint(
                "[R]Empty  Receipt  [R]\n" +
                        ...
                        "[C]<font size='small'>EMPB -  "+dcno+"</font>\n" +
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(DuraEmptyPrintView.this, DuraEmptyPrintMain.class));
    }
