...
public class DeliveryPrintDB extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "printdelidb.db";
    ...
    public DeliveryPrintDB(@Nullable Context context) {
