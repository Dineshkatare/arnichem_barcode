...
public class outwardPrintDB extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "outwardPrintDB.db";
    ...
    public outwardPrintDB(@Nullable Context context) {
    ...
    public void addBook(String cylinder,String deliDate,String cnane,String totalQ,String dcno){
