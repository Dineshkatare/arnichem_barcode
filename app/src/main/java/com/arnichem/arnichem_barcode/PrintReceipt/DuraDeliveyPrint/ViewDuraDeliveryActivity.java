...
//
//public class ViewDuraDeliveryActivity extends AppCompatActivity {
...
//        databaseHandlercustomer = new DatabaseHandler(ViewDuraDeliveryActivity.this);
...
//        super.onBackPressed();
//        startActivity(new Intent(ViewDuraDeliveryActivity.this, MainPrintActivity.class));
//    }
//    private void postrequ()
//    {
//
//
//        dialog = new ProgressDialog(ViewDuraDeliveryActivity.this);
...
//            }
//        };
//        VolleySingleton.getInstance(ViewDuraDeliveryActivity.this).addToRequestQueue(stringRequest);
//
//
...
//            }
//        };
//        VolleySingleton.getInstance(ViewDuraDeliveryActivity.this).addToRequestQueue(stringRequest1);
//
//
//
...
//                                Toast.makeText(ViewDuraDeliveryActivity.this, ""+object.getString("path"), Toast.LENGTH_SHORT).show();
//
//                            } catch (JSONException e) {
//                                dialog.dismiss();
//                                e.printStackTrace();
...
//            }
//        };
//        VolleySingleton.getInstance(ViewDuraDeliveryActivity.this).addToRequestQueue(stringRequest2);
//    }
//
//    private void setImage(String path) {
//
//        String base_url =  SharedPref.getInstance(ViewDuraDeliveryActivity.this).getBaseUrl();
//
