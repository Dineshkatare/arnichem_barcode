...
public class GodownEmptyPrintView extends AppCompatActivity {
    Button duradelprint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addClymyDB=new GodownEmpPrintDB(GodownEmptyPrintView.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(GodownEmptyPrintView.this, GodownEmptyPrintMainActivity.class));
    }
}