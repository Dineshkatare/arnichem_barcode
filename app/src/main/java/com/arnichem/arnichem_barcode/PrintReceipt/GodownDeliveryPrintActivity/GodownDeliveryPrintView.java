...
public class GodownDeliveryPrintView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deliDB=new GodownDelPrintDB(GodownDeliveryPrintView.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(GodownDeliveryPrintView.this, GodownDeliveryMainActivity.class));
    }
}