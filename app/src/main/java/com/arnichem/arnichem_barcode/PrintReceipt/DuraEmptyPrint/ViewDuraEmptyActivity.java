...
public class ViewDuraEmptyActivity extends AppCompatActivity {
    Button duradelprint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_dura_empty);
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        empbid = findViewById(R.id.empbid);
        dateid = findViewById(R.id.dateid);
        databaseHandlercustomer = new DatabaseHandler(ViewDuraEmptyActivity.this);
    ...
    private void postrequ() {
        ...
        dialog = new ProgressDialog(ViewDuraEmptyActivity.this);
        ...
        VolleySingleton.getInstance(ViewDuraEmptyActivity.this).addToRequestQueue(stringRequest);
...
//        counttxt.setText(totalQuan);
        ...
        VolleySingleton.getInstance(ViewDuraEmptyActivity.this).addToRequestQueue(stringRequest1);
                    ...
                    public void onResponse(String response) {
                        ...
                        for (int i = 0; i < array.length(); i++) {
                            ...
                            try {
                                ...
                                Toast.makeText(ViewDuraEmptyActivity.this, ""+object.getString("path"), Toast.LENGTH_SHORT).show();
        ...
        VolleySingleton.getInstance(ViewDuraEmptyActivity.this).addToRequestQueue(stringRequest2);
    }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(ViewDuraEmptyActivity.this, MainPrintActivity.class));
    }

    private void setImage(String path) {

        String base_url =  SharedPref.getInstance(ViewDuraEmptyActivity.this).getBaseUrl();
