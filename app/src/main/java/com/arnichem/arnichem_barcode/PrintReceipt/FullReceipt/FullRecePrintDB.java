...
public class FullRecePrintDB extends SQLiteOpenHelper {
    private Context context;
    private static final String DATABASE_NAME = "FullRecePrintDB.db";
    ...
    public FullRecePrintDB(@Nullable Context context) {
