...
public class EmptyPrintAdapter extends RecyclerView.Adapter<EmptyPrintAdapter.OxygenHolder>{
    private Context context;
    private Activity activity;
    private ArrayList id;
    private ArrayList dcno;
    EmptyPrintAdapter(Activity activity, Context context, ArrayList id, ArrayList dcno
    ){
