...
public class InwardPrintView extends AppCompatActivity {
    Button duradelprint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addClymyDB=new InwardprintDB(InwardPrintView.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(InwardPrintView.this, InwardPrintMainActivity.class));
    }
}