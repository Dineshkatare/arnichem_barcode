package com.arnichem.arnichem_barcode.PrintReceipt.GodownEmptyPrintActivity;
...
public class GodownEmptyPrintMainActivity extends AppCompatActivity {
    ArrayList<String> id, dcno;
    RecyclerView recyclerView;
    GodownEmpPriAdapter delhisadapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_godown_empty_print_main);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        id=new ArrayList<String>();
        dcno=new ArrayList<String>();
        getSupportActionBar().setTitle("Godown Empty Print History");
        ...
        storeDataInArrays();
        delhisadapter = new GodownEmpPriAdapter(GodownEmptyPrintMainActivity.this,this, id, dcno);
        recyclerView.setAdapter(delhisadapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(GodownEmptyPrintMainActivity.this));
    }
...
//            empty_imageview.setVisibility(View.VISIBLE);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(GodownEmptyPrintMainActivity.this, MainPrintActivity.class));
    }
}