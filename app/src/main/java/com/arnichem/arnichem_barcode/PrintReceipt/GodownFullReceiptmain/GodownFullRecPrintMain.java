...
public class GodownFullRecPrintMain extends AppCompatActivity {
    ArrayList<String> id, dcno;
    RecyclerView recyclerView;
    GodownFullPrintAdapter delhisadapter;
    GodownFullPrintDB delhisdb;
    TextView dateView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        setContentView(R.layout.activity_godown_full_rec_print_main);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        id=new ArrayList<String>();
        dcno=new ArrayList<String>();
        getSupportActionBar().setTitle("Godown Full Receipt Print History");
        ...
        delhisdb=new GodownFullPrintDB(this);
        storeDataInArrays();
        delhisadapter = new GodownFullPrintAdapter(GodownFullRecPrintMain.this,this, id, dcno);
        recyclerView.setAdapter(delhisadapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(GodownFullRecPrintMain.this));
    }
...
//            empty_imageview.setVisibility(View.VISIBLE);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(GodownFullRecPrintMain.this, MainPrintActivity.class));
    }
}