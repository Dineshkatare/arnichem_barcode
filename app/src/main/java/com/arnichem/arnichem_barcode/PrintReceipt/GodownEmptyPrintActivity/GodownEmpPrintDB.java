...
public class GodownEmpPrintDB extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "GodownEmpPrintDB.db";
    ...
    private static final String totalQuantity = "totalQuan";
    private static final String DC_NO = "DCNO";

    public GodownEmpPrintDB(@Nullable Context context) {
    ...
    public void addBook(String cylinder,String deliDate,String ccode,String cnane,String totalQ,String dcno){
