...
public class GodownFullPrintDB extends SQLiteOpenHelper {
    private Context context;
    private static final String DATABASE_NAME = "GodownFullPrintDB.db";
    ...
    public GodownFullPrintDB(@Nullable Context context) {
