...
public class Empty_Print extends AppCompatActivity {
    ...
    TextView empbid, dateid, custnameid, cylindernumberempty, arnichemdignprint, counttxt, tvcode, vehicleno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        filledWithAdapter = new FilledWithAdapter(Empty_Print.this, this, name, tot);
        fillwithrec.setAdapter(filledWithAdapter);
        cylinderNamePrintAdapter = new CylinderNamePrintAdapter(Empty_Print.this, this, cylIdList, newlist,
                fillWithList);
        cyclinderNames.setAdapter(cylinderNamePrintAdapter);
        cyclinderNames.setLayoutManager(new LinearLayoutManager(Empty_Print.this));
        fillwithrec.setLayoutManager(new LinearLayoutManager(Empty_Print.this));
    ...
    public void cylinder() {
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                emptyPrintDB.addBook(cursor.getString(1), DateFormat.getDateTimeInstance().format(new Date()),
                        cust_code, custname, count, empb);
            }
        }
    }
    ...
    public AsyncEscPosPrinter getAsyncEscPosPrinter(DeviceConnection printerConnection) {
        ...
        return printer.setTextToPrint(
                "[C]        Empty  Receipt  \n" +
                        ...
                        "[C]<font size='small'>Vehicle No    :  " + SharedPref.getInstance(this).getVehicleNo()
                        + "</font>\n" +
