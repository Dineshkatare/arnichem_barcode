...
public class DuraemptyHelper extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "DuraemptyHelper.db";
    ...
    public DuraemptyHelper(@Nullable Context context) {
