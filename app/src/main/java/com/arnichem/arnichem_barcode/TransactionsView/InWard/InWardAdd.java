...
public class InWardAdd extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_ward_add);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        frameLayout=findViewById(R.id.frameinward);
        myDB=new InWardDatabaseHelper(InWardAdd.this);
        synchelper=new syncHelper(InWardAdd.this);
            ...
            public void onDecoded(@NonNull final Result result) {
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(res==null)
                        {
                            Toast.makeText(InWardAdd.this, "null", Toast.LENGTH_SHORT).show();
...
//        });
        finish.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(InWardAdd.this, InWardMain.class));
            }
        });
