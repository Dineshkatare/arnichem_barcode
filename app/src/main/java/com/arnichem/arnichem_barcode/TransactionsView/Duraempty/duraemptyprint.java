...
public class duraemptyprint extends AppCompatActivity {
    Button duradelprint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addClymyDB=new DuraemptyHelper(duraemptyprint.this);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(duraemptyprint.this, Transactions.class));
    }
