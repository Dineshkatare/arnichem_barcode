...
public class deliAdapter extends RecyclerView.Adapter<deliAdapter.ViewHolder>  {

    private Context context;
    private Activity activity;
    private ArrayList book_id, book_title;
    public deliAdapter(Activity activity, Context context, ArrayList book_id, ArrayList book_title
    ){
