...
public class InWardDatabaseHelper extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "Inwardb.db";
    ...
    public InWardDatabaseHelper(@Nullable Context context) {
