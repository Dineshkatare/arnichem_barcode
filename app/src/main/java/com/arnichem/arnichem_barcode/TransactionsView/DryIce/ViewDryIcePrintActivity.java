...
//
//public class ViewDryIcePrintActivity extends AppCompatActivity {
...
//        setContentView(R.layout.activity_view_dry_ice_print);
//        empbid = findViewById(R.id.cdcnoid);
//        dateid = findViewById(R.id.cddateid);
//        signedImg = findViewById(R.id.custnamesign);
//
//        newlist = new ArrayList<>();
//        databaseHandlercustomer = new DatabaseHandler(ViewDryIcePrintActivity.this);
...
//        super.onBackPressed();
//        startActivity(new Intent(ViewDryIcePrintActivity.this, MainPrintActivity.class));
//    }
//
//    private void postrequ() {
//
//
//        dialog = new ProgressDialog(ViewDryIcePrintActivity.this);
...
//            }
//        };
//        VolleySingleton.getInstance(ViewDryIcePrintActivity.this).addToRequestQueue(stringRequest);
//
//
...
//            }
//        };
//        VolleySingleton.getInstance(ViewDryIcePrintActivity.this).addToRequestQueue(stringRequest1);
//
//
...
//                                Toast.makeText(ViewDryIcePrintActivity.this, "" + object.getString("path"), Toast.LENGTH_SHORT).show();
//
//                            } catch (JSONException e) {
//                                dialog.dismiss();
//                                e.printStackTrace();
...
//            }
//        };
//        VolleySingleton.getInstance(ViewDryIcePrintActivity.this).addToRequestQueue(stringRequest2);
//    }
//
//    private void setImage(String path) {
//
//        String base_url = SharedPref.getInstance(ViewDryIcePrintActivity.this).getBaseUrl();
//
