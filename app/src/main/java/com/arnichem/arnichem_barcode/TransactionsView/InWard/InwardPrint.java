...
public class InwardPrint extends AppCompatActivity {
    Button duradelprint;
    ...
    InWardDatabaseHelper addClymyDB;
    ArrayList<String> newlist;
    InwardprintDB inwardprintDB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inward_print);
        this.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_PORTRAIT);
        empbid=findViewById(R.id.empbid);
        dateid=findViewById(R.id.dateid);
        addClymyDB=new InWardDatabaseHelper(InwardPrint.this);
        ...
        inwardprintDB=new InwardprintDB(this);
        Intent i=getIntent();
    ...
    public void cylinder() {
        ...
        if (cursor.getCount() == 0) {
            ...
            while (cursor.moveToNext()) {
                ...
                inwardprintDB.addBook(cursor.getString(1),DateFormat.getDateTimeInstance().format(new Date()),custname,count,empb);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(InwardPrint.this, Transactions.class));
    }
