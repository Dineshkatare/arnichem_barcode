...
public class CO2Filling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_co2_filling);
      ...
      //  loadata();
        ...
        oxygenHelper=new Co2Helper(this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(distributorname.isEmpty()){
                    MDToast.makeText(CO2Filling.this, "कृपया distributor निवडा !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();
...
//                if (manifoldpos == 0) {
//
//                    MDToast.makeText(CO2Filling.this, "कृपया manifold निवडा !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();
//
...
//                } else {
//                    status =true;
//                    Intent intent =new Intent(CO2Filling.this, NewScanner.class);
...
//        });
        print.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(CO2Filling.this, Co2Print.class);
        ...
        adddata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (manifoldpos == 0) {
                    ...
                    MDToast.makeText(CO2Filling.this, "कृपया सिलेंडर नंबर टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                }else if(cylindervolume.getText().toString().isEmpty()){
                    MDToast.makeText(CO2Filling.this, "कृपया सिलेंडर व्हॉल्युम टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();
        ...
        spinnerDistributor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(distributorname.equalsIgnoreCase(SharedPref.getInstance(CO2Filling.this).getOwnCode()))
                {
                ...
                if (cursor.getCount() == 0) {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        {
                            if(distributorname.equalsIgnoreCase(SharedPref.getInstance(CO2Filling.this).getOwnCode())){
                                temp  = SharedPref.getInstance(CO2Filling.this).getOwnCode();
                            }else {
                                temp=col1;
        ...
        oxygenAdapter = new No2Adapter(CO2Filling.this,this, id, cylindername,dis,vol);
        recyclerView.setAdapter(oxygenAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(CO2Filling.this));
        distna=new distnameadapter(CO2Filling.this,this,iddist,disname,distot,distotvol);
        recyclerView1.setAdapter(distna);
        recyclerView1.setLayoutManager(new LinearLayoutManager(CO2Filling.this));
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (manifoldpos == 0) {
                            ...
                            Intent intent = new Intent(CO2Filling.this, ProductionLaserScannerActivity.class);
                            intent.putExtra("type", "co2");
                            intent.putExtra("dis", distributorname);
...
//            empty_imageview.setVisibility(View.VISIBLE);
            ...
            while (cursor.moveToNext()){
                ...
                if (cursor.getString(2).equals(SharedPref.getInstance(CO2Filling.this).getOwnCode())) {
                    temp=SharedPref.getInstance(CO2Filling.this).getOwnCode();
                } else {
    ...
    void check(){
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                if(cursor.getString(3).equals(SharedPref.getInstance(CO2Filling.this).getOwnCode()))
                {
    ...
    private void Oxygenpost() {
        progressDialog = new ProgressDialog(CO2Filling.this);
        progressDialog.setTitle("Uploading");
        progressDialog.setMessage("Please wait....");
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.show();
        // creating a new variable for our request queue
        RequestQueue queue = Volley.newRequestQueue(CO2Filling.this);
        StringRequest request = new StringRequest(Request.Method.POST, APIClient.CO2_entry, new com.android.volley.Response.Listener<String>() {
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        if (status.equals("success")) {
                            ...
                            MDToast.makeText(CO2Filling.this, "CO2 Fill Entry Done !", MDToast.LENGTH_SHORT, MDToast.TYPE_SUCCESS).show();
                            progressDialog.dismiss();
                            batch_id = object.getString("batch_id");
                            Intent intent = new Intent(CO2Filling.this, Co2Print.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressDialog.dismiss();
                Toast.makeText(CO2Filling.this, "Fail to get response = " + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("supervisor", SharedPref.getInstance(CO2Filling.this).Id());
                params.put("email", SharedPref.getInstance(CO2Filling.this).getEmail());
