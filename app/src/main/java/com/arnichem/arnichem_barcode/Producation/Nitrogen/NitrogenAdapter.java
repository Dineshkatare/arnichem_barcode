...
public class NitrogenAdapter extends RecyclerView.Adapter<NitrogenAdapter.OxygenHolder>{
    private Context context;
    private Activity activity;
    private ArrayList id, cyname,dist,vol;
    NitrogenAdapter(Activity activity, Context context, ArrayList id, ArrayList cyname,ArrayList dist, ArrayList vol
    ){
    ...
    @NonNull
    @Override
    public NitrogenAdapter.OxygenHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.oxygen_row, parent, false);
        return new NitrogenAdapter.OxygenHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull @NotNull NitrogenAdapter.OxygenHolder holder, int position) {
        ...
        holder.deletebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, NitrogenFilling.class);
