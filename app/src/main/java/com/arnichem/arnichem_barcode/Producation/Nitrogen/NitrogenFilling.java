package com.arnichem.arnichem_barcode.Producation.Nitrogen;
...
public class NitrogenFilling extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nitrogen_filling);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Nitrogen Cylinder Fill");
        ...
        oxygenHelper=new NitrogenHelper(this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(distributorname.isEmpty()){
                    MDToast.makeText(NitrogenFilling.this, "कृपया distributor निवडा !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();
        ...
        print.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(NitrogenFilling.this, NitrogenPrint.class);
        ...
        adddata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (manifoldpos == 0) {
                    ...
                    MDToast.makeText(NitrogenFilling.this, "कृपया manifold निवडा !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                }else if(distributorpos==0){
                    MDToast.makeText(NitrogenFilling.this, "कृपया distributor निवडा !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                } else if(cylindernumber1.getText().toString().isEmpty()){
                    MDToast.makeText(NitrogenFilling.this, "कृपया सिलेंडर नंबर टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();
        ...
        spinnerDistributor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(distributorname.equalsIgnoreCase(SharedPref.getInstance(NitrogenFilling.this).getOwnCode()))
                {
                ...
                if (cursor.getCount() == 0) {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        {
                            if(distributorname.equalsIgnoreCase(SharedPref.getInstance(NitrogenFilling.this).getOwnCode())){
                                temp  = SharedPref.getInstance(NitrogenFilling.this).getOwnCode();
                            }else {
                                temp=col1;
        ...
        oxygenAdapter = new NitrogenAdapter(NitrogenFilling.this,this, id, cylindername,dis,vol);
        recyclerView.setAdapter(oxygenAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(NitrogenFilling.this));
        distna=new distnameadapter(NitrogenFilling.this,this,iddist,disname,distot,distotvol);
        recyclerView1.setAdapter(distna);
        recyclerView1.setLayoutManager(new LinearLayoutManager(NitrogenFilling.this));
                ...
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        if (manifoldpos == 0) {
                            ...
                            Intent intent = new Intent(NitrogenFilling.this, ProductionLaserScannerActivity.class);
                            intent.putExtra("type", "no2");
...
//                            intent.putExtra("vol", cylindervolume.getText().toString());
        ...
        mAddCameraScanFab.setOnClickListener(
                new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        status = true;
                        Intent intent = new Intent(NitrogenFilling.this, NewScanner.class);
...
//        no2_scan.setOnClickListener(new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
//                if (manifoldpos == 0) {
//
...
//            empty_imageview.setVisibility(View.VISIBLE);
            ...
            while (cursor.moveToNext()){
                ...
                if (cursor.getString(2).equals(SharedPref.getInstance(NitrogenFilling.this).getOwnCode())) {
                    temp=SharedPref.getInstance(NitrogenFilling.this).getOwnCode();
                } else {
    ...
    void check(){
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                if(cursor.getString(3).equals(SharedPref.getInstance(NitrogenFilling.this).getOwnCode()))
                {
    ...
    private void Oxygenpost() {
        ...
        progressDialog = new ProgressDialog(NitrogenFilling.this);
        progressDialog.setTitle("Uploading");
        progressDialog.setMessage("Please wait....");
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.show();
        // creating a new variable for our request queue
        RequestQueue queue = Volley.newRequestQueue(NitrogenFilling.this);
        StringRequest request = new StringRequest(Request.Method.POST,APIClient.NO2_entry, new com.android.volley.Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                progressDialog.dismiss();
                MDToast.makeText(NitrogenFilling.this, "Nitrogen Fill Entry Done !", MDToast.LENGTH_SHORT, MDToast.TYPE_SUCCESS).show();
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        if (status.equals("success")) {
                            ...
                            Intent intent = new Intent(NitrogenFilling.this, NitrogenPrint.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(NitrogenFilling.this, "Fail to get response = " + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("supervisor", SharedPref.getInstance(NitrogenFilling.this).Id());
                params.put("email", SharedPref.getInstance(NitrogenFilling.this).getEmail());
