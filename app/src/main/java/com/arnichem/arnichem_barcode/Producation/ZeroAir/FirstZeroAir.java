...
public class FirstZeroAir extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_zero_air);
        ...
        nextbutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    MDToast.makeText(FirstZeroAir.this, "कृपया Start Time टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                }
                else if(TextUtils.isEmpty(endtime))
                {
                    MDToast.makeText(FirstZeroAir.this, "कृपया End Time टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                }
                else if(before_tank_pressure.getText().toString().isEmpty())
                {
                    MDToast.makeText(FirstZeroAir.this, "कृपया Start Tank Pressure टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                }
                else if(before_tank_liquid_liter.getText().toString().isEmpty())
                {
                    MDToast.makeText(FirstZeroAir.this, "कृपया Start Tank Volume टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();


                }
                else if(after_tank_pressure.getText().toString().isEmpty())
                {
                    MDToast.makeText(FirstZeroAir.this, "कृपया End Tank Pressure टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                }
                else if(after_tank_liquid_liter.getText().toString().isEmpty())
                {
                    MDToast.makeText(FirstZeroAir.this, "कृपया End Tank Volume टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();
                ...
                {
                    MDToast.makeText(FirstZeroAir.this, "कृपया Filling Pressure टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                }
                else {

                    Intent intent = new Intent(FirstZeroAir.this, ZeroAirFilling.class);
