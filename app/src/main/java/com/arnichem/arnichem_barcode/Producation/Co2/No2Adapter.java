...
public class No2Adapter extends RecyclerView.Adapter<No2Adapter.OxygenHolder>{
    private Context context;
    private Activity activity;
    private ArrayList id, cyname,dist,vol;
    public No2Adapter(Activity activity, Context context, ArrayList id, ArrayList cyname, ArrayList dist, ArrayList vol
    ){
    ...
    @NonNull
    @Override
    public No2Adapter.OxygenHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.oxygen_row, parent, false);
        return new No2Adapter.OxygenHolder(view);
    }
    @Override
    public void onBindViewHolder(@NonNull @NotNull No2Adapter.OxygenHolder holder, int position) {
        ...
        holder.deletebutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(context, CO2Filling.class);
