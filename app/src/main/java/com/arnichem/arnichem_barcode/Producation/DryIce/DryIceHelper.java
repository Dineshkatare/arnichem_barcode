...
public class DryIceHelper extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "DryIceHelper.db";
    ...
    public DryIceHelper(@Nullable Context context) {
