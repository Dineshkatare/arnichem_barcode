...
import com.arnichem.arnichem_barcode.Producation.Co2.No2Adapter;
...
public class DryIceMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dry_ice_main);
        ...
        co2_scan = findViewById(R.id.co2_scan);
        ...
        dryIceHelper=new DryIceHelper(this);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(distributorname.isEmpty()){
                    MDToast.makeText(DryIceMain.this, "कृपया distributor निवडा !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();
        ...
        co2_scan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (manifoldpos == 0) {

                    MDToast.makeText(DryIceMain.this, "कृपया manifold निवडा !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();
                    ...
                    status =true;
                    Intent intent =new Intent(DryIceMain.this, NewScanner.class);
        ...
        print.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(DryIceMain.this, Co2Print.class);
        ...
        adddata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (manifoldpos == 0) {
                    ...
                    MDToast.makeText(DryIceMain.this, "कृपया सिलेंडर नंबर टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                }else if(cylindervolume.getText().toString().isEmpty()){
                    MDToast.makeText(DryIceMain.this, "कृपया सिलेंडर व्हॉल्युम टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                }else {
                    dryIceHelper.addBook(cylindernumber1.getText().toString(), distributorname, cylindervolume.getText().toString(),"no");
                    finish();
        ...
        spinnerDistributor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(distributorname.equalsIgnoreCase(SharedPref.getInstance(DryIceMain.this).getOwnCode()))
                {
                ...
                if (cursor.getCount() == 0) {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        {
                            if(distributorname.equalsIgnoreCase(SharedPref.getInstance(DryIceMain.this).getOwnCode())){
                                temp  = SharedPref.getInstance(DryIceMain.this).getOwnCode();
                            }else {
                                temp=col1;
        ...
        oxygenAdapter = new No2Adapter(DryIceMain.this,this, id, cylindername,dis,vol);
        recyclerView.setAdapter(oxygenAdapter);
        recyclerView.setLayoutManager(new LinearLayoutManager(DryIceMain.this));
        distna=new distnameadapter(DryIceMain.this,this,iddist,disname,distot,distotvol);
        recyclerView1.setAdapter(distna);
        recyclerView1.setLayoutManager(new LinearLayoutManager(DryIceMain.this));
    ...
    void storeDataInArrays(){
        Cursor cursor = dryIceHelper.readAllData();
        if(cursor.getCount() == 0){
//            empty_imageview.setVisibility(View.VISIBLE);
            ...
            while (cursor.moveToNext()){
                ...
                if (cursor.getString(2).equals(SharedPref.getInstance(DryIceMain.this).getOwnCode())) {
                    temp=SharedPref.getInstance(DryIceMain.this).getOwnCode();
                } else {
    ...
    void check(){
        Cursor cursor = dryIceHelper.readcount();
        if(cursor.getCount() == 0){
        }else{
            while (cursor.moveToNext()){
                ...
                if(cursor.getString(3).equals(SharedPref.getInstance(DryIceMain.this).getOwnCode()))
                {
        ...
        cylindernumber.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                if (manifoldpos == 0) {
                    ...
                    dryIceHelper.addBook(cylindernumber.getText().toString(), distributorname, tempvol,"no");
                    finish();
                    startActivity(getIntent());
    ...
    private void Oxygenpost() {
        progressDialog = new ProgressDialog(DryIceMain.this);
        progressDialog.setTitle("Uploading");
        progressDialog.setMessage("Please wait....");
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.show();
        // creating a new variable for our request queue
        RequestQueue queue = Volley.newRequestQueue(DryIceMain.this);
        StringRequest request = new StringRequest(Request.Method.POST, APIClient.CO2_entry, new com.android.volley.Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        if (status.equals("success")) {
                            ...
                            MDToast.makeText(DryIceMain.this, "Dry Ice Production Entry Done !", MDToast.LENGTH_SHORT, MDToast.TYPE_SUCCESS).show();
                            progressDialog.dismiss();
                            batch_id = object.getString("batch_id");
                            Intent intent = new Intent(DryIceMain.this, Co2Print.class);
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                progressDialog.dismiss();
                Toast.makeText(DryIceMain.this, "Fail to get response = " + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("supervisor", SharedPref.getInstance(DryIceMain.this).Id());
                params.put("email", SharedPref.getInstance(DryIceMain.this).getEmail());
