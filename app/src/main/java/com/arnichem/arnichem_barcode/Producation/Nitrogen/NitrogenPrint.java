...
import com.arnichem.arnichem_barcode.Producation.Oxygen.OxygenFillPrint;
...
public class NitrogenPrint extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nitrogen_print);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Nitrogen Cylinder Fill Print");
        empbid=findViewById(R.id.batchidprint);
        dateid=findViewById(R.id.dateidprint);
        addClymyDB=new NitrogenHelper(NitrogenPrint.this);
        distributorHelper=new DistributorHelper(NitrogenPrint.this);
        ...
        oxygenAdapter = new oxygenprintadapter(NitrogenPrint.this,this, id, cylindername,dis,vol);
        oxyrecy.setAdapter(oxygenAdapter);
        oxyrecy.setLayoutManager(new LinearLayoutManager(NitrogenPrint.this));
    ...
    void storeDataInArrays(){
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                if (cursor.getString(2).equalsIgnoreCase(SharedPref.getInstance( NitrogenPrint.this).getOwnCode())) {
                    temp=SharedPref.getInstance(NitrogenPrint.this).getOwnCode();
                } else {
    ...
    public AsyncEscPosPrinter getAsyncEscPosPrinter(DeviceConnection printerConnection) {
        ...
        return printer.setTextToPrint(
                "[C]<font size='small'>Nitrogen Fill</font>\n" +
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(NitrogenPrint.this, FirstNitrogen.class));
    }
}