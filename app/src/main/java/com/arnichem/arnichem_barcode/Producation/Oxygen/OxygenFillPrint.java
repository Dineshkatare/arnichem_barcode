...
public class OxygenFillPrint extends AppCompatActivity {
    ...
    List<String> cubic;
    String temp,tempvol,distributorname="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_oxygen_fill_print);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Oxygen Cylinder Fill Print");
        empbid=findViewById(R.id.batchidprint);
        dateid=findViewById(R.id.dateidprint);
        addClymyDB=new OxygenHelper(OxygenFillPrint.this);
        distributorHelper=new DistributorHelper(OxygenFillPrint.this);
        ...
        oxygenAdapter = new oxygenprintadapter(OxygenFillPrint.this,this, id, cylindername,dis,vol);
        oxyrecy.setAdapter(oxygenAdapter);
        oxyrecy.setLayoutManager(new LinearLayoutManager(OxygenFillPrint.this));


        String print_logo = SharedPref.mInstance.getPrintLogo();
        if (print_logo != null) {
            // Use the print_logo variable
            ...
            // Handle the case when print_logo is null
        }
    ...
    void storeDataInArrays(){
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                if (cursor.getString(2).equalsIgnoreCase(SharedPref.getInstance(OxygenFillPrint.this).getOwnCode())) {
                    temp=SharedPref.getInstance(OxygenFillPrint.this).getOwnCode();
                } else {
    ...
    public AsyncEscPosPrinter getAsyncEscPosPrinter(DeviceConnection printerConnection) {
        ...
        return printer.setTextToPrint(
                        "[C]<font size='small'>Oxygen Fill</font>\n" +
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(OxygenFillPrint.this, FisrtPart.class));
    }
}