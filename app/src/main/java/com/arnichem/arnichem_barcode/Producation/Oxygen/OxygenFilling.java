...
//FloatingActionButton o2_scan;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_oxygen_filling);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("Oxygen Cylinder Filling");
        ...
        oxygenHelper=new OxygenHelper(this);
        ...
        print.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(OxygenFilling.this, OxygenFillPrint.class);
        ...
        adddata.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (manifoldpos == 0) {
                    ...
                    MDToast.makeText(OxygenFilling.this, "कृपया सिलेंडर नंबर टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();

                }else if(cylindervolume.getText().toString().isEmpty()){
                    MDToast.makeText(OxygenFilling.this, "कृपया सिलेंडर व्हॉल्युम टाका !", MDToast.LENGTH_SHORT, MDToast.TYPE_ERROR).show();
...
//        });
        ...
        spinnerDistributor.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(distributorname.equalsIgnoreCase(SharedPref.getInstance(OxygenFilling.this).getOwnCode()))
                {
                ...
                if (cursor.getCount() == 0) {
                    ...
                    while (cursor.moveToNext()) {
                        ...
                        {
                            if(distributorname.equalsIgnoreCase(SharedPref.getInstance(OxygenFilling.this).getOwnCode())){
                                temp  = SharedPref.getInstance(OxygenFilling.this).getOwnCode();
                            }else {
                                temp=col1;
...
//            empty_imageview.setVisibility(View.VISIBLE);
            ...
            while (cursor.moveToNext()){
                ...
                if (cursor.getString(2).equalsIgnoreCase(SharedPref.getInstance(OxygenFilling.this).getOwnCode())) {
                    temp=SharedPref.getInstance(OxygenFilling.this).getOwnCode();
                } else {
    ...
    void check(){
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                if(cursor.getString(3).equals(SharedPref.getInstance(OxygenFilling.this).getOwnCode()))
                {
    ...
    private void Oxygenpost() {
      ...
      //  Toast.makeText(this, "Selected : "+Selected.toString(), Toast.LENGTH_SHORT).show();
        progressDialog = new ProgressDialog(OxygenFilling.this);
        progressDialog.setTitle("Uploading");
        progressDialog.setMessage("Please wait....");
        progressDialog.setProgressStyle(ProgressDialog.STYLE_SPINNER);
        progressDialog.show();
        // creating a new variable for our request queue
        RequestQueue queue = Volley.newRequestQueue(OxygenFilling.this);
        StringRequest request = new StringRequest(Request.Method.POST, APIClient.O2_entry, new com.android.volley.Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        if (status.equals("success")) {
                            MDToast.makeText(OxygenFilling.this, "Oxygen Filling Entry Done !", MDToast.LENGTH_SHORT, MDToast.TYPE_SUCCESS).show();
        ...
        Intent intent = new Intent(OxygenFilling.this, OxygenFillPrint.class);
        ...
        //  SharedPref.getInstance(getApplicationContext()).(object.getString("lname"));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                submit.setEnabled(true);
                Toast.makeText(OxygenFilling.this, "Fail to get response = " + error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
            protected Map<String, String> getParams() {
                ...
                params.put("supervisor", SharedPref.getInstance(OxygenFilling.this).Id());
                params.put("email", SharedPref.getInstance(OxygenFilling.this).getEmail());
