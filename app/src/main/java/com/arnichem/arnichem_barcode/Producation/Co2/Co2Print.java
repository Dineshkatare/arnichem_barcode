...
public class Co2Print extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_co2_print);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("CO2 Cylinder Fill Print");
        empbid=findViewById(R.id.batchidprint);
        dateid=findViewById(R.id.dateidprint);
        addClymyDB=new Co2Helper(Co2Print.this);
        distributorHelper=new DistributorHelper(Co2Print.this);
        ...
        oxygenAdapter = new oxygenprintadapter(Co2Print.this,this, id, cylindername,dis,vol);
        oxyrecy.setAdapter(oxygenAdapter);
        oxyrecy.setLayoutManager(new LinearLayoutManager(Co2Print.this));
    ...
    void storeDataInArrays(){
        ...
        if(cursor.getCount() == 0){
            ...
            while (cursor.moveToNext()){
                ...
                if (cursor.getString(2).equalsIgnoreCase(SharedPref.getInstance(Co2Print.this).getOwnCode())) {
                    temp=SharedPref.getInstance(Co2Print.this).getOwnCode();
                } else {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(Co2Print.this, FisrtPart.class));
    }
}