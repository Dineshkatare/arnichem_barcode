...
public class OxygenHelper extends SQLiteOpenHelper {

    private Context context;
    private static final String DATABASE_NAME = "OxygenHelper.db";
    ...
    public OxygenHelper(@Nullable Context context) {
    ...
    Cursor readcount() {
        String query = "SELECT " + COLUMN_ID + ",SUM(" + COLUMN_vol + "),COUNT(" + COLUMN_dis + ")," + COLUMN_dis
                + " FROM " + TABLE_NAME + " GROUP BY " + COLUMN_dis;
        SQLiteDatabase db = this.getReadableDatabase();
